        ...
        <div className="w-full max-w-[420px] space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <div className="pt-2">
              ...
              <p className="text-sm text-zinc-400 mt-1">
                Get started with ARM64 inference optimization
              </p>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-[#111827] border border-[#1F293D] p-6 space-y-5">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Email */}
              <div className="space-y-1.5">
                <label htmlFor="signupEmail" className="block text-xs font-medium text-zinc-300">
                  Work email
                </label>
                <input
                  id="signupEmail"
              ...
              {/* Password */}
              <div className="space-y-1.5">
                <label htmlFor="signupPassword" className="block text-xs font-medium text-zinc-300">
                  Password
                </label>
                ...
                {password && (
                  <div className="flex items-center gap-2 pt-1">
                    <div className="flex-1 h-1 bg-[#1F293D] rounded-full overflow-hidden flex gap-0.5">
                      {[1, 2, 3, 4].map((i) => (
                        <div
                          key={i}
                    ...
                    <span className="text-[10px] font-mono text-zinc-400">{strength.label}</span>
                  </div>
                )}
              </div>
              ...
              {/* Confirm Password */}
              <div className="space-y-1.5">
                <label htmlFor="confirmPassword" className="block text-xs font-medium text-zinc-300">
                  Confirm password
                </label>
                <input
                  id="confirmPassword"
                  ...
                  className={`w-full px-3.5 py-2.5 rounded-lg bg-[#0B0F19] border text-white text-sm placeholder:text-zinc-500 focus:outline-none transition-colors ${
                    confirmPassword && confirmPassword !== password
                      ? "border-red-500/60 focus:border-red-500/60 focus:ring-1 focus:ring-red-500/30"
                      : "border-[#1F293D] focus:border-orange-500/60 focus:ring-1 focus:ring-orange-500/30"
                  }`}
                />
                {confirmPassword && confirmPassword !== password && (
